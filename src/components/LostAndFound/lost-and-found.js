  ...
  constructor(props) {
    ...
    this.sounds = new Howl({
      ...
      sprite: {
        ...
        LF_correct: [124000, 2000],
        LF_incorrect: [127000, 2000],
      },
    })
    this.source = 0
  }
            ...
            <div className="clouds">
              <div className="lost-and-found">
                <div className="lf-text">
                  on the planet Aguilera, things aren't always as they seem. the
                  mirrored terrain casts uncertain glances over every shoulder.
                  will the reflections cast shadows of doubt, or will they show
                  your Xibis who they truly are inside?
                </div>
                <div className="lf-text">
                  the Xibis need to find themselves in the Great Fog of Doubt.
                  don't let the mirrors play tricks on them--or you! you have 20
                  seconds to locate your Xibis and dissipate the fog...
                </div>
              ...
              <div className="lost-and-found">
                ...
                {this.state.won ? (
                  <>
                    ...
                    <h4>
                      you have unlocked a new puzzle...visit the map to see!
                    </h4>
                  </>
                ) : (
                  <>
                    <h3>time's up! </h3>
                    <h4>you found {this.state.found} Xibis</h4>
